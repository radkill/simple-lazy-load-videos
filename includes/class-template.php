	...
	class SLLV_template {
		...
		public $vimeo = '
			<svg width="76" height="43" viewBox="0 0 76 43">
				<path class="b-video__button-shape" d="M5,0H70.5a5.3,5.3,0,0,1,5.333,5V38A5.3,5.3,0,0,1,70.5,43H5a5,5,0,0,1-5-5V5A5,5,0,0,1,5,0Z"/>
				<path class="b-video__button-icon" d="M31.034,30.98L31,31V12l15.834,9.456Z"/>
			</svg>';
		...
		public function video( $args = array() ) {
		  $args = wp_parse_args( $args, array(
			...
			<div class="b-video -type_<?php echo $args['provider']; ?>" data-provider="<?php echo $args['provider']; ?>" data-video="<?php echo $args['id']; ?>">
